      ...
      write(*,*)
      write(*,*) 'vaspout2position-> CONTCAR to s_position.fdf'
      write(*,*) 'please copy s_getdata.lammps here'
      write(*,*) 'run before strain_1.** directory'
      write(*,*) 'available for strain'
      ...
      open(10, file='s_getdata.lammps', status='old', &
      ...
      !##### check output
      write(*,*)
      write(*,*) 'Total assumed file to be created'
      write(*,*) num_fil
      write(*,*) 'Files will not be created'
      write(*,*) fil_no_ex
      write(*,*)
...
200   continue 
      ...
      if( fil_no_ex .eq. 0) then
        write(*,*)
        write(*,*) 'Files created...'
        write(*,*) num_fil
        write(*,*)
      elseif( fil_no_ex .ne. 0) then
        write(*,*)
        write(*,*) 'Total assumed file to be created'
        write(*,*) num_fil
        write(*,*) 'Files not be created'
        write(*,*) fil_no_ex
        write(*,*)
        write(*,*) 'check it manually'
        write(*,*)
      endif
